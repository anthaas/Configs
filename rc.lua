...
if beautiful.wallpaper then
    for s = 1, screen.count() do
        gears.wallpaper.maximized("/home/tuxanek/wallpaper.jpg", s, true)
    end
end
-- }}}
    ...
    vicious.register(batwidget, vicious.widgets.bat,
        function (widget, args)
            if args[2] < 12 and args[1] == "-" then
                ...
                return "".. colwhi.. " batt: " .. coldef .. colbred .. args[2] .. "% " .. coldef .. ""
            else
                return "" .. colwhi .. " batt: " .. coldef .. colbwhi .. args[2] .. "% " .. coldef .. ""
            end
        end, 121, "BAT1"    )
